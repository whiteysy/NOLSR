...
public:
  ...
  RoutingTableCalculator(int nRouters)
  {
    m_nRouters = nRouters;
  }
protected:
...
{
public:
  LinkStateRoutingTableCalculator(int nRouters)
  ...
  void
  calculatePath (RoutingTable& rt, ConfParameter& confParam, TupleState& tuplestate);
  void
  calculateSimplePath (RoutingTable& rt1, ConfParameter& confParam1, TupleState& tuplestate1);
  void
  calculateMutiPath (RoutingTable& rt2, ConfParameter& confParam2, TupleState& tuplestate2);
